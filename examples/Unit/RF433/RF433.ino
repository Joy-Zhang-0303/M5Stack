        ...
        do {
            ...
            if (cnt > 1) {
                ...
                if (((dataitem.duration0 + dataitem.duration1) < 1100) &&
                    ...
                    Serial.printf("%d %d:%d,%d:%d ", hex_cnt, dataitem.level0, dataitem.duration0, dataitem.level1,
                                  dataitem.duration1);
                    return hex_cnt;
                }
            }
    ...
    while (rb) {
        ...
        if (item != nullptr) {
            if (rx_size != 0) {
                ...
                if ((size >= 5) && (databuff[0] == 0xaa) && (databuff[1] == 0x55) && (databuff[2] == 0x01) &&
